...
extension BusinessProfileByIndex on IsarCollection<BusinessProfile> {
  Future<BusinessProfile?> getByUuid(String uuid) {
    return getByIndex(r'uuid', [uuid]);
  }

  BusinessProfile? getByUuidSync(String uuid) {
  ...
  Future<List<BusinessProfile?>> getAllByUuid(List<String> uuidValues) {
    final values = uuidValues.map((e) => [e]).toList();
    return getAllByIndex(r'uuid', values);
  }

  List<BusinessProfile?> getAllByUuidSync(List<String> uuidValues) {
    final values = uuidValues.map((e) => [e]).toList();
  ...
  Future<Id> putByUuid(BusinessProfile object) {
    return putByIndex(r'uuid', object);
  }

  Id putByUuidSync(BusinessProfile object, {bool saveLinks = true}) {
    return putByIndexSync(r'uuid', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByUuid(List<BusinessProfile> objects) {
    return putAllByIndex(r'uuid', objects);
  }

  List<Id> putAllByUuidSync(List<BusinessProfile> objects,
      {bool saveLinks = true}) {
...
extension BusinessProfileQueryWhere
  ...
  QueryBuilder<BusinessProfile, BusinessProfile, QAfterWhereClause> uuidEqualTo(
      String uuid) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<BusinessProfile, BusinessProfile, QAfterWhereClause> nameEqualTo(
      String name) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'name',
...
extension BusinessProfileQuerySortBy
  ...
  QueryBuilder<BusinessProfile, BusinessProfile, QAfterSortBy> sortByUuid() {
    return QueryBuilder.apply(this, (query) {
...
extension BusinessProfileQuerySortThenBy
  ...
  QueryBuilder<BusinessProfile, BusinessProfile, QAfterSortBy> thenByUuid() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'uuid', Sort.asc);
    });
  }
...
extension BusinessProfileQueryWhereDistinct
  ...
  QueryBuilder<BusinessProfile, BusinessProfile, QDistinct> distinctByUuid(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension BusinessProfileQueryProperty
  ...
  QueryBuilder<BusinessProfile, String, QQueryOperations> uuidProperty() {
    return QueryBuilder.apply(this, (query) {
